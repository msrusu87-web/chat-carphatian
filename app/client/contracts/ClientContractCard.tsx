...
export default function ClientContractCard({ contract }: ClientContractCardProps) {
            ...
            <div className="bg-gray-800/50 backdrop-blur border border-gray-700 rounded-2xl p-6">
                <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                        ...
                        <p className="text-gray-400 text-sm">Freelancer: {contract.freelancer?.email || 'Unknown'}</p>
                    </div>
                    <span className={`px-4 py-2 rounded-full text-sm font-medium ${contract.status === 'active' ? 'bg-green-500/20 text-green-400' :
                ...
                {totalMilestones > 0 && (
                    <div className="mb-4">
                        <div className="flex items-center justify-between mb-2 text-sm">
                            ...
                            <span className="text-gray-300">{completedMilestones}/{totalMilestones} milestones completed</span>
                        </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    {(contract.status === 'active' || contract.status === 'paused') && (
                        <Link
                            href={`/client/messages?freelancer=${contract.freelancer_id}`}
